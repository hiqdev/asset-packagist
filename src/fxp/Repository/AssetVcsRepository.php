...
use hiqdev\assetpackagist\fxp\Package\LazyCompletePackage;
use hiqdev\assetpackagist\fxp\Package\Version\VersionParser;
use hiqdev\assetpackagist\fxp\Util\Validator;
...
class AssetVcsRepository extends AbstractAssetVcsRepository
{
    ...
    {
        $packageClass = 'hiqdev\assetpackagist\fxp\Package\LazyCompletePackage';
