...
use hiqdev\assetpackagist\fxp\Converter\NpmPackageUtil;
use hiqdev\assetpackagist\fxp\Converter\PackageUtil;
use hiqdev\assetpackagist\fxp\Exception\InvalidCreateRepositoryException;
